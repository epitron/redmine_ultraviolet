...
You can pick the theme in Redmine's user interface (via a drop-down list). You'll probably want to consult {this handy page of what the themes actually look like}[http://ultraviolet.rubyforge.org/themes.xhtml] to pick a good one.
