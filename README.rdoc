...
You can pick which theme you would like to use in Redmine's user interface (via a drop-down list). You'll probably want to look at "this handy page of what the themes actually look like":http://ultraviolet.rubyforge.org/themes.xhtml to decide.
