...
The highlighter's default colour scheme ("theme") is currently ((<pastels_on_dark|URL:http://ultraviolet.rubyforge.org/themes.xhtml#pastels_on_dark>)).

You can pick the theme in Redmine's user interface (via a drop-down list). You'll probably want to consult ((<this handy page of what the themes actually look like|URL:http://ultraviolet.rubyforge.org/themes.xhtml>)) to pick a good one.
