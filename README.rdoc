...
The highlighter's default theme is currently hard-wired to use "pastels_on_dark": http://ultraviolet.rubyforge.org/themes.xhtml#pastels_on_dark

You can change it by modifying +DEFAULT_UV_THEME+ in +lib/ultraviolet_synax_patch.rb+.

Users can select which higlighting theme they want to use. A field called Ultraviolet Theme is available to users.
The field has been prepopulated with currently available themes.
